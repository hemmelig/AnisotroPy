...
class TestMaterials(unittest.TestCase):
    def test_load_materials(self):
        ...
        self.assertRaises(errors.InvalidMaterialID, materials.load, "not_a_material")
        print("\t\t ...tests pass!")
    ...
    def test_voigt_reuss_hill_averaging(self):
        ...
        vrh_C, _, voigt_C, reuss_C = materials.voigt_reuss_hill_average(
            [material1, material2], [0.2, 0.8]
        )
        print(
            "\tTest 1 - testing the Voigt averaging function using\n"
        ...
        print(
            "\tTest 2 - testing the Reuss averaging function using\n"
            "\t\t two simple isotropic materials..."
        )
        ...
        print(
            "\tTest 3 - testing the VRH averaging function using\n"
            "\t\t two simple isotropic materials..."
        )
        ...
        print(
            "\tTest 4 - testing a suite of cases where one\n\t\t expects a"
            " warning to be raised..."
        )
        self.assertWarns(
            Warning,
            materials.voigt_reuss_hill_average,
            [material1, material2],
            [0.3, 0.8],
        )
        print("\t\t ...tests pass!")
    ...
    def test_isotropic_elastic_tensor(self):
        ...
        template = (
            "\tTest {number} - building an isotropic elastic tensor "
            "from\n\t\t {arguments}..."
        )
        ...
        print(
            template.format(
                number=3, arguments="the Lame parameters, la and mu, and rho"
            )
        )
        ...
        print(
            template.format(
                number=4, arguments="the elastic moduli, K and G, and rho"
            )
        )
        ...
        print(
            "\tTest 5 - testing a suite of cases where one\n\t\t expects an"
            " exception to be raised..."
        )
        self.assertRaises(
            errors.MissingDensityValue, materials.isotropic_C, K=8.0, G=6.0
        )
        self.assertRaises(
            errors.InsufficientElasticInformation,
            materials.isotropic_C,
            K=3.0,
            rho=3.0,
        )
        self.assertRaises(
            errors.InsufficientElasticInformation, materials.isotropic_C, vp=3.0
        )
        self.assertRaises(
            errors.InsufficientElasticInformation,
            materials.isotropic_C,
